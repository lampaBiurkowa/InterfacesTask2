...
namespace DibryBand
{
    ...
    {
        public float MaxFrequency => FrequencyMapper.Instance.GetHzFromNote("C5");
        public float MinFrequency => FrequencyMapper.Instance.GetHzFromNote("A2");
        ...
        public void Play(IList<float> notes)
        {
            ...
            foreach (var note in notes)
            {
                ...
                if (note >= FrequencyMapper.Instance.GetHzFromNote("B4") && (emotion == EmotionType.Subtle || emotion == EmotionType.Sad))
